...
public class SecurityConfig {
    ...
    public RoleHierarchy roleHierarchy() {
        return RoleHierarchyImpl.withDefaultRolePrefix()
                .role("MANAGER").implies("CURATOR")
                .role("CURATOR").implies("AUDIENCE")
                .build();
    }
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/v1/programs", "/api/v1/programs/**", "/api/v1/taste/keywords/hot").permitAll() // 명세상 단건/목록 조회는 게스트도 봐야 하니 추가함
    ...
    // RoleHierarchy를 @PreAuthorize에도 적용
    @Bean
